CREATE DATABASE IF NOT EXISTS `livrariadoro`;
USE `livrariadoro`;
...
CREATE TABLE `livraria` (
  ...
  `TituloLivro` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ISBNLivro` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `usuario` (
  ...
  `Nome` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Senha` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`IdADM`)
